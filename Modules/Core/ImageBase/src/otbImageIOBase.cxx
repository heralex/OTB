...
const ImageIOBase::ArrayOfExtensionsType& ImageIOBase::GetSupportedReadExtensions() const
{
...
void ImageIOBase::Resize(const unsigned int numDimensions, const unsigned int* dimensions)
{
...
bool ImageIOBase::SetPixelTypeInfo(const std::type_info& ptype)
{
  ...
  if (!itkSetPixelType(this, ptype, ImageIOBase::CHAR, char(0)) && !itkSetPixelType(this, ptype, ImageIOBase::UCHAR, (unsigned char)0) &&
...
ImageIOBase::SizeType ImageIOBase::GetImageSizeInPixels() const
{
  unsigned int i;
...
ImageIOBase::SizeType ImageIOBase::GetPixelStride() const
{
  return m_Strides[1];
}

ImageIOBase::SizeType ImageIOBase::GetRowStride() const
{
  return m_Strides[2];
}

ImageIOBase::SizeType ImageIOBase::GetSliceStride() const
{
  return m_Strides[3];
}
...
bool ImageIOBase::ReadBufferAsBinary(std::istream& is, void* buffer, ImageIOBase::SizeType num)
{
...
void ImageIOBase::WriteBufferAsASCII(std::ostream& os, const void* buffer, IOComponentType ctype, ImageIOBase::SizeType numComp)
{
  switch (ctype)
  {
  case UCHAR:
...
void ImageIOBase::ReadBufferAsASCII(std::istream& is, void* buffer, IOComponentType ctype, ImageIOBase::SizeType numComp)
{
  switch (ctype)
  {
  case UCHAR:
...
unsigned int ImageIOBase::GetActualNumberOfSplitsForWritingCanStreamWrite(unsigned int numberOfRequestedSplits, const itk::ImageIORegion& pasteRegion) const
{
...
unsigned int ImageIOBase::GetActualNumberOfSplitsForWriting(unsigned int numberOfRequestedSplits, const itk::ImageIORegion& pasteRegion,
...
itk::ImageIORegion ImageIOBase::GetSplitRegionForWritingCanStreamWrite(unsigned int ithPiece, unsigned int numberOfActualSplits,
...
itk::ImageIORegion ImageIOBase::GetSplitRegionForWriting(unsigned int ithPiece, unsigned int numberOfActualSplits, const itk::ImageIORegion& pasteRegion,
                                                         const itk::ImageIORegion& largestPossibleRegion)
{
  if (this->CanStreamWrite())
  {
 ...
 * RequestedRegion */
itk::ImageIORegion ImageIOBase::GenerateStreamableReadRegionFromRequestedRegion(const itk::ImageIORegion& requested) const
{
  //
  ...
  unsigned int maxDimension = minIODimension > requested.GetImageDimension() ? minIODimension : requested.GetImageDimension();
